...
cw.visit(52, ACC_PUBLIC + ACC_SUPER, "com/nebula/dropwizard/core/Todo2", null, "java/lang/Object", null);
...
mv.visitFieldInsn(PUTFIELD, "com/nebula/dropwizard/core/Todo2", "completed", "Lnebula/define/YesNo;");
Label l2 = new Label();
mv.visitLabel(l2);
mv.visitLineNumber(13, l2);
mv.visitVarInsn(ALOAD, 0);
mv.visitVarInsn(ALOAD, 2);
mv.visitFieldInsn(PUTFIELD, "com/nebula/dropwizard/core/Todo2", "title", "Lnebula/define/Title;");
Label l3 = new Label();
mv.visitLabel(l3);
...
Label l4 = new Label();
mv.visitLabel(l4);
mv.visitLocalVariable("this", "Lcom/nebula/dropwizard/core/Todo2;", null, l0, l4, 0);
...
mv.visitVarInsn(ALOAD, 0);
mv.visitVarInsn(ALOAD, 1);
mv.visitMethodInsn(INVOKEVIRTUAL, "com/nebula/dropwizard/core/Todo2", "setTitle", "(Lnebula/define/Title;)V", false);
Label l1 = new Label();
mv.visitLabel(l1);
...
mv.visitVarInsn(ALOAD, 0);
mv.visitFieldInsn(GETFIELD, "com/nebula/dropwizard/core/Todo2", "completed", "Lnebula/define/YesNo;");
...
mv.visitVarInsn(ALOAD, 0);
mv.visitFieldInsn(GETFIELD, "com/nebula/dropwizard/core/Todo2", "title", "Lnebula/define/Title;");
mv.visitInsn(ARETURN);
Label l1 = new Label();
mv.visitLabel(l1);
mv.visitLocalVariable("this", "Lcom/nebula/dropwizard/core/Todo2;", null, l0, l1, 0);
